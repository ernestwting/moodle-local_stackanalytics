...
/**
 * Streams a PDF export of the dashboard — whichever of the Model 1 / Model 2
 * / Diagnostics sections were ticked on the "Download PDF" form
 * (dashboard_renderer::render_pdf_form()), re-derived server-side from the
 * same report-builder classes index.php uses, respecting the same quiz
 * filter. A separate entry point from index.php, gated by the same
 * local/stackanalytics:view capability.
 *
...
use local_stackanalytics\analytics\pdf_content;
use local_stackanalytics\analytics\pdf_builder;
